...
public class S3Test {
    ...
    public void simpleS3Test() throws IOException {
        ...
        AwsCredentialsProvider creds = StaticCredentialsProvider.create(
                AwsBasicCredentials.create("AKIATJEJUG5R7Z27V643", "pgrFB4vUVS6p5e/imu7eKn1nSeLJ+r1OwlNLImzv"));
        ...
        var fileFlux = DataBufferUtils.readAsynchronousFileChannel(
                () -> fileChannel,
...
//        future.join();
        ...
        Mono.fromFuture(future).doOnError(this::handleError).map(this::checkResult).then();
